		...
		<div class = 'wrapper'>	
			<div class = 'main'>
				...
				<div class = 'spaceContent'>
					<div class = 'spaceText'>
						Упс, кажется меню не работает. Попробуйте перейти в <a href="/">меню</a> позже, возможна ошибка на сервере!
						<p><img src="http://oboi.cc/uploads/11_05_2013/view/201210/oboik.ru_51051.jpg" width = '100%' alt="Беда"></p>
					</div>
				</div>
			</div>
		</div>
